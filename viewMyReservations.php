...
<body>
    ...
    $stmt = $conn->prepare("SELECT * FROM reservation WHERE user_id = $userid" );
    $stmt->execute();
    ...
    while($row = $stmt->fetch()){ ?>
                   ...
                   <div class="single-product mt-3">
                        ...
                        <div class="product-info">
                            <span class="category">Your Reservation</span>
                            <h4 class="title">
                                <div class="row">
                                <div class="col-md-2">
                                    <div>
                                        <span><?php echo $row['name'] ?></span>
                                        <span><?php echo $row['Telephone_Number'] ?></span>
                                    </div>
                                </div>
    ...
    <div class="container">
        <h1 class="text-center text-primary">You have not placed any Reservations</h1>
    </div>
    <?php
}
    ?>
