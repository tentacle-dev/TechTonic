...
<html lang="en">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        while($row = $stmt->fetch()){?>
                         <li class="nav-item"><a class="nav-link" href="category.php?id=<?php echo $row['id'] ?>"><?php echo $row['name'] ?></a></li>
                        <?php }


                        ?>
                        <li class="nav-item"><a class="nav-link" href="../Cart/cart3.php">Cart<span class="badge bg-dark text-white ms-1 rounded-pill">2</span></a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <div class="d-flex align-items-start flex-column-reverse">
        <div class="p-2 icon" id="showbtn" onclick="showChatbot()"><i class="fa fa-comment"></i>
               </div>
        <div class="p-2 content" style="display:none" id="content">
            <div class="row">
                <div class="col-md-11"></div>
                <div class="col-md-1" onclick="hideChatbot()"><i class="fas fa-window-close"></i></div>
            </div>
            <iframe 
                    allow="microphone;"
                    height="400"
        ...
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">A new type of storefront.</h3>
                </div>
                <div class="row text-center">
                    <div class="col-md-4">
                        ...
                        <p class="text-muted">Enrich your shopping list wisely.</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                        ...
                        <h4 class="my-3">Understanding customers</h4>
                        <p class="text-muted">“Make a customer, not a sale.” – Katherine Barchetti
                    ...
                    <div class="col-md-4">
                        ...
                        <p class="text-muted">Nothing less than the best. Our business is protecting yours. Our Commitment is Keeping you Safe. Our Concern is Security.</p>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <a href="category.php?id=1" class="btn btn-primary btn-xl text-uppercase">View more</a>
