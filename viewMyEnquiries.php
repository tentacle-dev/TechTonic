...
<body>
    ...
    <section class="trending-product section" style="margin-top: 12px;">
        ...
        $stmt = $conn->prepare("SELECT * FROM product_enquiry AS enq INNER JOIN product AS product ON enq.product_id = product.product_id WHERE enq.user_id = $userid" );
        $stmt->execute();
        $enqcount = $stmt->RowCount();
        if($enqcount > 0){
            ...
            ?>
                   ...
                   <div class="single-product mt-3">
                        ...
                        <div class="product-info">
                            <span class="category">Your enquiry for <?php echo $productname ?> on <?php echo $date ?></span>
                            <h4 class="title">
                                <div class="row">
                                        <div>
                                            <span><?php echo $row['enquiry'] ?></span>
                                        </div>
                                </div>
                                
                                <div class="row price">
                                            <span><?php echo $row['response'] ?></span>
                                </div>
                            </h4>
    ...
    You have no enquiry on any products
    </h1></div><?php
}
    ?>
